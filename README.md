...
<div align="center">
  ...
  <p><b>torq does.</b> Every set you log is scored with the DOTS formula, the same
  normalisation powerlifting uses to compare a 60&nbsp;kg lifter with a 95&nbsp;kg one,
  then turned into a rank you climb across nine tiers.</p>
</div>
...
<table>
<tr>
<td width="50%" align="center"><img src="docs/shots/framed/workout.png" alt="Routines" /><br/><b>Routines and a real plan</b><br/><sub>Pick your goal, your days and your focus, and torq builds the training week around them</sub></td>
<td width="50%" align="center"><img src="docs/shots/framed/profile.png" alt="Profile" /><br/><b>Your athlete card</b><br/><sub>Rank, best lifts and percentiles, shareable as a story image</sub></td>
</tr>
</table>
